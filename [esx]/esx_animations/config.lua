...
Config.Animations = {
...

	{
		...
		items = {
			...
			{label = "Shek", type = "anim", data = {lib = "mp_ped_interaction", anim = "handshake_guy_a"}},
...

	{
		...
		items = {
			...
			{label = "Convenience store: repair the engine", type = "anim", data = {lib = "mini@repair", anim = "fixing_a_ped"}},
			...
			{label = "Clochard: Doing the round", type = "scenario", data = {anim = "WORLD_HUMAN_BUM_FREEWAY"}},
