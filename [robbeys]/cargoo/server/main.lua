...
RegisterServerEvent('Sheikhaay_ki_nono:resetEvent')
AddEventHandler('Sheikhaay_ki_nono:resetEvent', function()
	LastDelivery = 0.0
end)
...
ESX.RegisterServerCallback('Sheikhaay_ki_nono:getCopsOnline', function(source, cb)
	cb(GetCopsOnline())
end)
...
ESX.RegisterServerCallback('Sheikhaay_ki_nono:sellCargo', function(source, cb, price)
...
ESX.RegisterServerCallback('Sheikhaay_ki_nono:buyCargo', function(source, cb, price)
